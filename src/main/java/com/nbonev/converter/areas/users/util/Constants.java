...
public class Constants {
    ...
    public static final String PASSWORD_NOT_EMPTY = "Password name must not be empty";
    public static final String PASSWORD_LENGTH = "Password must be between 4 and 14 characters long";
